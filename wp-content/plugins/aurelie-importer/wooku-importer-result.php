...
<div class="woo_product_importer_wrapper wrap">
    ...
    <h2><?php _e( 'Aurelie Product Importer &raquo; Results', 'wooku-importer' ); ?></h2>
    ...
    <div id="import_status">
        <div id="import_in_progress">
            <img src="<?php echo plugin_dir_url(__FILE__); ?>img/ajax-loader.gif"
                alt="<?php _( 'Importing. Please do not close this window or click your browser\'s stop button.', 'wooku-importer' ); ?>"
                title="<?php _e( 'Importing. Please do not close this window or click your browser\'s stop button.', 'wooku-importer' ); ?>">

            <strong><?php _e( 'Importing. Please do not close this window or click your browser\'s stop button.', 'wooku-importer' ); ?></strong>
        </div>
        <div id="import_complete">
            <img src="<?php echo plugin_dir_url(__FILE__); ?>img/complete.png"
                alt="<?php _e( 'Import complete!', 'wooku-importer' ); ?>"
                title="<?php _e( 'Import complete!', 'wooku-importer' ); ?>">
            <strong><?php _e( 'Import Complete! Results below.', 'wooku-importer' ); ?></strong>
        </div>

        <table>
            <tbody>
                <tr>
                    <th><?php _e( 'Processed', 'wooku-importer' ); ?></th>
                    <td id="insert_count">0</td>
                </tr>
                <tr>
                    <th><?php _e( 'Remainin', 'wooku-importer' ); ?>g</th>
                    <td id="remaining_count"><?php echo $_POST['row_count']; ?></td>
                </tr>
                <tr>
                    <th><?php _e( 'Total', 'wooku-importer' ); ?></th>
    ...
    <table id="inserted_rows" class="wp-list-table widefat fixed pages" cellspacing="0">
        <thead>
            <tr>
                ...
                <th style="width: 80px;"><?php _e( 'CSV Row', 'wooku-importer' ); ?></th>
                <th style="width: 80px;"><?php _e( 'New Post ID', 'wooku-importer' ); ?></th>
                <th><?php _e( 'Name', 'wooku-importer' ); ?></th>
                <th><?php _e( 'SKU', 'wooku-importer' ); ?></th>
                <th style="width: 120px;"><?php _e( 'Price', 'wooku-importer' ); ?></th>
                <th><?php _e( 'Result', 'wooku-importer' ); ?></th>
            </tr>
        </thead>
        <tbody><!-- rows inserted via AJAX --></tbody>
    </table>

    <p><a id="show_debug" href="#" class="button"><?php _e( 'Show Raw AJAX Responses', 'wooku-importer' ); ?></a></p>
