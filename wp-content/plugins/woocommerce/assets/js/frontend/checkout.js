jQuery(document).ready(function($) {
	...
	function update_checkout() {
		...
		/**
		 * #order_levering must be included too (by daniel)
		 */
		$('#order_methods, #order_review, #order_levering').block({message: null, overlayCSS: {background: '#fff url(' + woocommerce_params.ajax_loader_url + ') no-repeat center', backgroundSize: '16px 16px', opacity: 0.6}});

		/**
		 * daniel code to update levering box too
		 * please see above 'order_levering'
		 **/
		
		data = {
			action: 			'woocommerce_update_order_levering',
			security: 			woocommerce_params.update_order_levering_nonce,
