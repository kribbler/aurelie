...
class Woocommerce {
	...
	public function frontend_scripts() {
		...
		/**
		 * overridden by daniel so that checkout.js is used instead of checkout-min.js
		 * I should pack checkout.js when ready
		 */
		$suffix = "";
		...
		$woocommerce_params = array(
			 ...
			 */
			'update_order_levering_nonce'      => wp_create_nonce( "update-order-levering" ),
