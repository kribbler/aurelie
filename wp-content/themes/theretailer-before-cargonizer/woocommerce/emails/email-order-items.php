...
foreach ($items as $item) :
	...
	?>
	<tr>
		<td style="text-align:left; vertical-align:middle; border-bottom: 1px solid #eee; font-size:12px"><?php
		...
		<td style="text-align:right; vertical-align:middle; border-bottom: 1px solid #eee;"><b><?php echo $order->get_formatted_line_subtotal( $item ); ?></b></td>
	</tr>
