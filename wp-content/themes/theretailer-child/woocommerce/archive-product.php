...
<?php
if (is_front_page()){
    echo '<style type="text/css">#price_filter-2{display:none;}</style>';
};
?>
...
<?php if (!is_front_page()){?>    
    ...
    <?php if ($_SERVER['REMOTE_ADDR'] == '83.103.200.163'){echo 'daniel - I am on child/archive-product.php';}?>
            ...
            <?php else : ?>
    <?php if ($_SERVER['REMOTE_ADDR'] == '83.103.200.163'){echo 'wowodaniel - I am child/on archive-product.php';}?>
