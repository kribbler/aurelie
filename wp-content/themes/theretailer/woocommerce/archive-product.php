...
<?php if (!is_front_page()){?>    
    ...
    <?php if ($_SERVER['REMOTE_ADDR'] == '83.103.200.163'){echo 'daniel - I am on archive-product.php';}?>
            ...
            <?php else : ?>
    <?php if ($_SERVER['REMOTE_ADDR'] == '83.103.200.163'){echo 'wowodaniel - I am on archive-product.php';}?>
