...
echo 'dssdg;ww'; //var_dump($_GET);die();
/*
...
$crg_consignment_costs_url = "http://sandbox.cargonizer.no/consignments_costs.xml";
...
if (isset($_GET['get_costs']) && $_GET['get_costs'] == "1"){
	$crg = new cargonizer($crg_api_key,$crg_sender_id,$crg_consignment_costs_url);
}
