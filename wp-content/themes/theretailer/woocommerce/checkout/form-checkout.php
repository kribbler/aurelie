...
<form name="checkout" method="post" class="checkout" action="<?php echo esc_url( $get_checkout_url ); ?>">
	...
	<?php if ( sizeof( $woocommerce_checkout->checkout_fields ) > 0 ) : ?>
		...
		<?php do_action('woocommerce_checkout_order_levering')?>
...
*/
	//include( 'cargonizer.no/cargonizer_tollpost_partifrakt.php' );
	//include( 'cargonizer.no/cargonizer_tollpost_mypack.php' );
