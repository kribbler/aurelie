...
<?php 
do_action('woocommerce_special_info_email', $order);
do_action( 'woocommerce_special_thankyou_' . $order->payment_method, $order->id );
?>
</ul>
...
<h2 style="font-size:18px; color:#000000"><?php _e( 'Order Details', 'woocommerce' ); ?></h2>
